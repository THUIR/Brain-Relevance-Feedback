from part4_context_analyses_utils import udr_click, rdr_bad_click
import json
import numpy as np
...
def paint_performance_regarding_context_udr():
    ...
    width = total_width / n
    fontsize=31
    fig, ax1= plt.subplots(nrows=1, ncols=1, figsize=(10, 11), sharey=True)
    ax2 = ax1.twinx()
...
def paint_performance_regarding_context_udr_fixed_parameters1():
    ...
    fontsize=31
    fig, ax2= plt.subplots(nrows=1, ncols=1, figsize=(10, 11), sharey=True)
    ax12 = ax2.twinx()
