...
parser.add_argument('-path',type=str, help='the combination weight of supervised signal eeg', required=False, default = '')
...
selected_runner = ['bqe(bs+c)', 'bert', 'bqe(c)', 'bqe(bs)', 'bqe(un)', 'sogou', 'bqe(bs-s)', 'bqe(c-s)', 'bqe(bs+c-s)', 'bqe(un-s)',] # 'brm3(bs+c-s)'
